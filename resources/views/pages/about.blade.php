    ...
    document.getElementById('send').addEventListener('click', async function() {
        ...
        try {
            ...
            if (data.message) {
                ...
                chatBox.innerHTML += `<div class='text-left flex items-center'><img src='/assets/jurpan.svg' alt='Jurpan' class='w-8 h-8 rounded-full mr-2'><p class='bg-gray-300 p-3 rounded-lg inline-block max-w-xs break-words'>${formattedMessage}</p></div>`;
            } else {
                chatBox.innerHTML += `<div class='text-left flex items-center'><img src='/assets/jurpan.svg' alt='Jurpan' class='w-8 h-8 rounded-full mr-2'><p class='bg-gray-300 p-3 rounded-lg inline-block max-w-xs break-words'>Tidak ada respon dari AI.</p></div>`;
            }
        } catch (error) {
            console.error("Error fetching data:", error);
            chatBox.innerHTML += `<div class='text-left flex items-center'><img src='/assets/jurpan.svg' alt='Jurpan' class='w-8 h-8 rounded-full mr-2'><p class='bg-gray-300 p-3 rounded-lg inline-block max-w-xs break-words'>Terjadi kesalahan.</p></div>`;
        } finally {
