...
<section id="Home"
    class="pt-16 pb-16 lg:pt-24 lg:pb-20 bg-backgroundLight min-h-screen max-w-screen overflow-hidden">
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap items-center">
             <div class="w-full self-center px-4 lg:w-1/2">
                <div class="flex flex-col">
                    <div class="flex space-x-2">
                        <h1 class="text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white" data-aos="fade-up">Temukan</h1>
                    </div>
                    <div class="flex space-x-2">
                        <h1 id="typing-text" class="text-5xl lg:text-6xl font-bold text-purpleMain" data-aos="fade-up"></h1>
            ...
            <div class="w-full lg:w-1/2 flex justify-center lg:justify-end lg:pl-32">
                <img src="/assets/img/hero.svg" class="float-animation max-w-[420px] h-auto" alt="gambar1" data-aos="zoom-in">
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-3">
                <div class="flex flex-wrap justify-center items-stretch gap-3 bg-white rounded-lg p-3 shadow-md">
                    ...
                    <div class="flex items-center">
                        <button class="bg-purpleMain text-white font-bold px-6 py-3 rounded-lg hover:bg-purple-700 transition-colors"
                            data-aos="">
                            Tes minatmu
                        </button>
                    </div>
...
<section id="tentang"
    ...
    <div class="container grid lg:grid-cols-10 gap-8">
        ...
        <div class="lg:col-span-5 flex justify-center items-center relative" data-aos="fade-left"
            ...
            <!-- Maskot -->
            <img src="{{ asset('assets/jurpan-home.svg') }}" alt="Jurusanku Owl Mascot"
    ...
    <div class="container mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4 p-4 bg-white rounded-lg transition shadow-md hover:shadow-lg hover:shadow-orange-200"
                        ...
                        <div class="p-2 bg-purpleMain rounded-full flex items-center justify-center w-10 h-10">
                            <img src="{{ asset('assets/fitur1.svg') }}" alt="Prospek Kerja" class="w-6 h-6  ">
                        </div>
                        <div>
                    ...
                    <div class="flex items-start gap-4 p-4 bg-white rounded-lg transition shadow-md hover:shadow-lg hover:shadow-orange-200"
                        data-aos="fade-up" data-aos-delay="200">
                        <div class="p-2 bg-purpleMain rounded-full flex items-center justify-center w-10 h-10">
                            <img src="{{ asset('assets/fitur2.svg') }}" alt="Chat Bot" class="w-6 h-6  ">
                        </div>
                        <div>
                    ...
                    <div class="flex items-start gap-4 p-4 bg-white rounded-lg transition shadow-md hover:shadow-lg hover:shadow-orange-200"
                        ...
                        <div class="p-2 bg-purpleMain rounded-full flex items-center justify-center w-10 h-10">
                            <img src="{{ asset('assets/fitur3.svg') }}" alt="Jurusan yang sesuai" class="w-6 h-6 ">
                        </div>
                        <div>
            ...
            <div class="relative w-4/5 mx-auto" data-aos="zoom-in">
                <img src="{{ asset('assets/fitur.png') }}" alt="Video Preview"
