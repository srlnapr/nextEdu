...
CREATE TABLE `artikel` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `nama_jurusan_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `artikel` (`id`, `created_at`, `updated_at`, `nama_jurusan_id`, `name`, `img`, `description`, `composition`, `dose`) VALUES
(1, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 1, 'Kurikulum Merdeka di SMA: Kenali Karakteristik dan Strukturnya', 'https://source.unsplash.com/w8p9cQDLX7I', 'Kurikulum Merdeka memberikan ruang lebih luas untuk pengembangan keterampilan yang dibutuhkan di dunia kerja, memberikan pengalaman belajar yang lebih relevan.', 'Sistem pembelajaran berbasis proyek, fleksibel, dan berbasis kompetensi akan membekali siswa dengan keterampilan praktis.', 'Diharapkan siswa dapat mengembangkan berbagai keterampilan sosial dan profesional untuk siap menghadapi tantangan pekerjaan.'),
(2, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 2, 'Memilih Jurusan Studi di SMA', 'https://source.unsplash.com/w8p9cQDLX7I', 'Memilih jurusan yang tepat di SMA merupakan langkah awal yang penting dalam merencanakan karier masa depan, karena ini akan mempengaruhi peluang pendidikan dan pekerjaan di masa depan.', 'Jurusan IPA, IPS, dan Bahasa menawarkan berbagai keterampilan yang relevan dengan berbagai pilihan karier profesional yang berbeda.', 'Penting untuk memilih jurusan yang sesuai dengan minat dan bakat agar lebih siap dalam menghadapi dunia kerja.'),
(3, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 3, 'Efektivitas Kebijakan Penghapusan Jurusan IPA, IPS, dan Bahasa di SMA', 'https://source.unsplash.com/w8p9cQDLX7I', 'Keputusan untuk menghapus pemisahan jurusan di SMA dapat memberikan fleksibilitas lebih besar bagi siswa untuk mengeksplorasi berbagai bidang ilmu dan keterampilan.', 'Kebijakan ini mendukung pengembangan keterampilan siswa secara lebih luas dan multidisipliner, yang dibutuhkan di dunia kerja yang semakin kompleks.', 'Siswa yang memiliki kesempatan untuk belajar berbagai bidang secara bersamaan dapat menjadi lebih siap beradaptasi dengan berbagai tantangan profesional.'),
(4, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 4, '20 Jurusan di SMK yang Paling Diminati dan Bergaji Tinggi', 'https://source.unsplash.com/w8p9cQDLX7I', 'Siswa SMK memiliki banyak pilihan jurusan yang sesuai dengan kebutuhan industri, di antaranya adalah jurusan teknik, kesehatan, dan desain yang menawarkan peluang karier yang sangat baik.', 'Jurusan teknik dan otomotif sering kali menawarkan kesempatan karier yang stabil dengan penghasilan yang tinggi, terutama jika siswa menguasai keterampilan praktis dan teknis.', 'Mengambil jurusan yang memiliki prospek karier yang jelas dan sesuai dengan perkembangan teknologi adalah langkah penting untuk kesuksesan profesional.'),
(5, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 5, 'Belajar Apa Aja Sih, di Sekolah Menengah Kejuruan (SMK)?', 'https://source.unsplash.com/w8p9cQDLX7I', 'Di SMK, siswa belajar berbagai keterampilan praktis yang langsung dapat diterapkan di dunia kerja, mulai dari teknisi, desainer, hingga pekerja sektor kreatif lainnya.', 'SMK menawarkan pendidikan yang langsung terhubung dengan kebutuhan pasar kerja, memberikan keterampilan yang sangat dicari oleh berbagai industri.', 'Dengan keterampilan yang tepat, lulusan SMK dapat langsung bekerja di berbagai bidang atau melanjutkan pendidikan ke jenjang yang lebih tinggi untuk meningkatkan karier mereka.'),
(6, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 6, '10 Pekerjaan Terbaik untuk Lulusan SMA/SMK, Bisa Sukses Gapai Karier Impian!', 'https://source.unsplash.com/w8p9cQDLX7I', 'Lulusan SMA dan SMK memiliki peluang besar untuk meraih karier impian, baik di dunia profesional maupun di bidang wirausaha.', 'Pekerjaan seperti manajer proyek, desainer grafis, hingga teknisi memiliki prospek yang sangat baik dengan potensi penghasilan yang tinggi.', 'Penting untuk memanfaatkan kesempatan belajar yang ada di sekolah dan memperluas keterampilan dengan mengikuti pelatihan atau magang di bidang yang diminati.'),
(7, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 7, 'Tantangan bagi Lulusan SMA dan SMK: Kesiapan Menghadapi Dunia Kerja', 'https://source.unsplash.com/w8p9cQDLX7I', 'Lulusan SMA dan SMK sering menghadapi tantangan dalam memasuki dunia kerja, seperti kurangnya pengalaman praktis dan persaingan ketat di pasar kerja.', 'Penting bagi mereka untuk terus mengembangkan keterampilan yang relevan, seperti keterampilan teknis dan soft skills seperti komunikasi dan teamwork.', 'Menjadi fleksibel dan beradaptasi dengan kebutuhan industri yang terus berkembang adalah kunci untuk sukses dalam karier.'),
(8, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 7, 'Peluang Karier Siswa SMK Setelah Lulus, Apa Saja Ya?', 'https://source.unsplash.com/w8p9cQDLX7I', 'Siswa SMK memiliki banyak peluang karier setelah lulus, dengan beberapa di antaranya dapat langsung memasuki dunia kerja atau melanjutkan pendidikan ke perguruan tinggi.', 'Pekerjaan di bidang teknik, otomotif, dan desain grafis sangat diminati dan dapat menawarkan gaji yang kompetitif.', 'Peluang untuk bekerja di perusahaan besar atau memulai usaha sendiri juga terbuka lebar bagi lulusan SMK yang memiliki keterampilan dan pengetahuan yang memadai.'),
(9, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 7, 'Masa Depan Setelah SMA: Antara Kuliah dan Berdaya Mandiri', 'https://source.unsplash.com/w8p9cQDLX7I', 'Setelah lulus SMA, siswa harus memilih antara melanjutkan pendidikan ke perguruan tinggi atau langsung bekerja untuk meraih kemandirian finansial.', 'Keputusan ini bergantung pada minat, kemampuan finansial, dan tujuan karier di masa depan.', 'Penting untuk mengeksplorasi semua pilihan dan memilih yang terbaik berdasarkan kebutuhan pribadi dan aspirasi karier.'),
(10, '2023-05-21 12:54:46', '2023-05-21 12:54:46', 7, 'Lulus SMA Kerja atau Kuliah? Pahami Kekurangan dan Kelebihannya!', 'https://source.unsplash.com/w8p9cQDLX7I', 'Memilih antara langsung bekerja atau melanjutkan pendidikan setelah SMA adalah keputusan besar yang harus dipikirkan matang-matang.', 'Bekerja segera setelah lulus memberikan keuntungan finansial dan pengalaman praktis, namun kuliah dapat membuka peluang karier yang lebih luas dengan gelar yang relevan.', 'Penting untuk mempertimbangkan prospek karier jangka panjang dan minat pribadi dalam mengambil keputusan tersebut.');
...
(1, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 1, 'Learn ways to lower your stress. Try deep breathing, gardening, taking a walk, meditating, working on your hobby, or listening to your favorite music.'),
(2, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 2, 'Choose foods that are lower in calories, saturated fat, trans fat, sugar, and salt.'),
(3, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 3, 'Eat foods with more fiber, such as whole grain cereals, breads, crackers, rice, or pasta.'),
(4, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 4, 'Learn ways to lower your stress. Try deep breathing, gardening, taking a walk, meditating, working on your hobby, or listening to your favorite music.'),
(5, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 5 'Choose foods that are lower in calories, saturated fat, trans fat, sugar, and salt.'),
(6, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 6 'Drink water instead of juice and regular soda.'),
(7, '2025-02-06 00:45:03', '2025-02-06 00:45:03', 7, 'Work out at least 150 minutes of exercise each week, divided into 5 sessions or days, 30 minutes per session. Use stretch bands, do yoga, heavy gardening (digging and planting with tools), or try push-ups.');
